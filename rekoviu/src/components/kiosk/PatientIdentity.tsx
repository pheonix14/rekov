...
export const PatientIdentity: React.FC<PatientIdentityProps> = ({ name, phone, onChange }) => {
  ...
  return (
    <div style={{
      background: 'rgba(255,255,255,.02)', border: '1px solid rgba(255,255,255,.08)', padding: 32
    }}>
      <div style={{ textAlign: 'center', marginBottom: 32 }}>
        <div style={{
          width: 56, height: 56, borderRadius: '50%', background: '#fff', margin: '0 auto 16px',
          display: 'flex', alignItems: 'center', justifyContent: 'center'
        }}>
          <span style={{ fontSize: 24, color: '#000' }}>{'\u25C8'}</span>
        </div>
        <h2 style={{ fontFamily: "'Bebas Neue'", fontSize: 28, color: '#fff', letterSpacing: '.06em' }}>PATIENT DETAILS</h2>
        <p style={{ fontFamily: "'Space Grotesk'", fontSize: 13, color: 'rgba(255,255,255,.4)', marginTop: 8 }}>
